...
x <- c("RColorBrewer", "devtools", "seewave", "maRce10/warbleR", "monitoR", "pkgdown", "ape", "spelling", "ggplot2", "png", "viridis", "maRce10/Rraven", "av", "ari", "gganimate", "imager"
       )
...
#sent to github
system("git add .")
system('git commit -m  "checking Matt changes"')
