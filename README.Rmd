...
![Static Spectrogram of a female barn swallow song](https://github.com/maRce10/dynaSpec/raw/master/inst/femaleBarnSwallow_1.png)

```
#let's add axes 
femaleBarnSwallow<-prep_static_ggspectro(f[1],destFolder=tempdir(),savePNG=T,onlyPlotSpec = F)
```
![Static spectrogram with axis labels for female barn swallow song](https://github.com/maRce10/dynaSpec/raw/master/inst/femaleBarnSwallow_1b.png)
...
pagedSpec(p2) 
```
![Static spectrogram with axis labels for female barn swallow song](https://github.com/maRce10/dynaSpec/raw/master/inst/femaleBarnSwallow_1c.png)
...
![Humpback whale song spectrogram](https://github.com/maRce10/dynaSpec/raw/master/inst/figure-markdown_github/humpback.png)
